...
- [x] 1.8 Implement `rma ping` command
- [x] 1.9 Implement `rma me` command
- [x] 1.10 Implement `rma profile add/use/list/delete` commands
- [x] 1.11 Implement `rma config show` command

## 2. Time Entries
- [x] 2.1 Implement Activity model and cache with TTL
- [x] 2.2 Implement `rma time activities list` command
- [x] 2.3 Implement TimeEntry model
- [x] 2.4 Implement `rma time create` command with activity name resolution
- [x] 2.5 Implement `rma time list` command with filters
- [x] 2.6 Implement `rma time get` command
- [x] 2.7 Implement `rma time update` command
- [x] 2.8 Implement `rma time delete` command

## 3. Projects
- [x] 3.1 Implement Project model
- [x] 3.2 Implement `rma project list` command with pagination
- [x] 3.3 Implement `rma project get` command (by id or identifier)

## 4. Issues
- [x] 4.1 Implement Issue model with related types (Tracker, Status, Priority)
- [x] 4.2 Implement `rma issue list` command with filters
- [x] 4.3 Implement `rma issue get` command
- [x] 4.4 Implement `rma issue create` command
- [x] 4.5 Implement `rma issue update` command
